...
public class CommAlertViewActivity extends AppCompatActivity implements OnItemClickListener,OnDismissListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.layout_activity_alertview);
            ...
            ViewGroup extView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.item_alert_view, null);
